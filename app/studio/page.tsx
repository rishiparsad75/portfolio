  ...
  return (
    <div className="min-h-screen bg-bg text-white pt-28 pb-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Local-only dev mode warning */}
        <div
          className="mb-8 px-5 py-4 rounded-xl text-sm font-medium flex items-center gap-3"
          style={{
        ...
        >
          ...
          <span>
            <strong>Local Dev Mode Only</strong> — This Studio works when running{" "}
            <code className="px-1.5 py-0.5 rounded bg-white/10 text-xs font-mono">npm run dev</code>.
            Changes won&apos;t persist on the deployed Azure site.
          </span>
        </div>
